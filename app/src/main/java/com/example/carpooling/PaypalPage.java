...
public class PaypalPage extends AppCompatActivity {
    ...
    public static final String clientKey = "AW5qNkihRYq79MIwT502hLGwcL0mjFhFLxXzST1HVPuE2msE3I4ct6SQwMQxgZN7zzGqq2j4BEVYZXn-";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        amountEdt = findViewById(R.id.cantidad);

        // creating a variable for button, edit text and status tv.
        Button makePaymentBtn = findViewById(R.id.payButton);
